...
class AboutUs extends Component {
  ...
  render() {
    return <div class="container"><div class="col-sm-12 justify-content-center text-center">
      ...
      <p className='about-us-paragraph'>Passionate towards crypto currency and their future transformation.<br />
      ...
      <p className='about-us-paragraph'>Once we have finished the initial development of our client's product, <br />
