                        ...
                        <Col className='d-flex align-items-stretch mb-2'>
                            <Card className="cardHover">
                                ...
                                <Card.Body>
                                    ...
                                    <Card.Text>
                                        <p className='about-us-paragraph lato'><strong>Need someone to join your
                                            operational team and help you meet your deadlines?</strong>
                                ...
                                <Card.Body>
                                    ...
                                    <Card.Text>
                                        <p className='about-us-paragraph lato'>
                                            ...
                                            <br/>
                                            We provide a team composed of expert back and front-end software engineers,
                                            with automated tests and continuous deployments.
                                            <br/>
                                        </p>
                                    </Card.Text>
                                </Card.Body>
                                ...
                                <Card.Body>
                                    ...
                                    <Card.Text>
                                        <p className='about-us-paragraph lato'><strong>Got a project in mind? </strong>
                                            ...
                                            <br/>
                                            We estimate the number of days required to build your features and we only
                                            charge based on the actual days used.
                                        </p>
                                    </Card.Text>
                                </Card.Body>
                                <Card.Footer>
